...
public class ReminderUtilities {
    ...
    private static final String REMINDER_JOB_TAG = "swallow_reminder_tag";

    private static boolean sInitialised;

    synchronized public static void scheduleSwallowReminder(@NonNull final Context context){
        ...
        Job reminderJob = dispatcher.newJobBuilder()
                .setService(SwallowReminderJobService.class)
